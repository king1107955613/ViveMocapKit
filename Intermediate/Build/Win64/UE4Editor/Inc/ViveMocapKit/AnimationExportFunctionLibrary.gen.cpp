...
// End Cross Module References
	DEFINE_FUNCTION(UAnimationExportFunctionLibrary::execExportAnimSequenceToBVH)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UAnimationExportFunctionLibrary::ExportAnimSequenceToBVH(Z_Param_AnimSequence,Z_Param_FileName,Z_Param_bFirstFrameReferencePose,Z_Param_bOverwrite,Z_Param_bLocalSpace);
		P_NATIVE_END;
	}
	...
	void Z_Construct_UFunction_UAnimationExportFunctionLibrary_ExportAnimSequenceToBVH_Statics::NewProp_bLocalSpace_SetBit(void* Obj)
	{
		((AnimationExportFunctionLibrary_eventExportAnimSequenceToBVH_Parms*)Obj)->bLocalSpace = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationExportFunctionLibrary_ExportAnimSequenceToBVH_Statics::NewProp_bLocalSpace = { "bLocalSpace", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationExportFunctionLibrary_eventExportAnimSequenceToBVH_Parms), &Z_Construct_UFunction_UAnimationExportFunctionLibrary_ExportAnimSequenceToBVH_Statics::NewProp_bLocalSpace_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAnimationExportFunctionLibrary_ExportAnimSequenceToBVH_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAnimationExportFunctionLibrary_ExportAnimSequenceToBVH_Statics::NewProp_bLocalSpace,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimationExportFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimationExportFunctionLibrary_ExportAnimSequenceToBVH, "ExportAnimSequenceToBVH" }, // 893404094
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimationExportFunctionLibrary, 2873851332);
