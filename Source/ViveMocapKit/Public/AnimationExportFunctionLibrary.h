...
public:
	...
	*/
	...
	static bool ExportAnimSequenceToBVH(const UAnimSequence* AnimSequence, const FString& FileName, bool bFirstFrameReferencePose = true, bool bOverwrite = true, bool bLocalSpace = true);
...
private:
	...
	*/
	...
	static void AddJointToBVHFile(int32 NestingNum, int32 BoneIndex, const FReferenceSkeleton& RefSkeleton, const TMultiMap<int32, int32>& Hierarchy, TSet<int32>& OutBonesOutput, TArray<FString>& OutData, bool bLocalSpace, TMap<int32, FTransform>& OutSkeletonOffsets);
};
